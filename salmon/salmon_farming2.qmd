...
This approach is standard in fisheries modeling (e.g., via software like OSMOSE or custom PDE solvers) and aligns with structured population theory from ecology and applied math.
